...
class Device:
    ...
    def set_bank(self, bank: int , preset: int = 0):
        """DEVID[3] CMD[1] 00 00 40 02 PRESET[2] 00 00 10 00 00 00 BANK[1] CRC[2]"""
        ...
        cmd: list = self._address[:]
        cmd += [self.CMD_SET_BANK, 0, 0, 0x40, 0x02]
        cmd += preset_addr
...
# Change presets/bank (presets 0, 1, 2, 3)
# F0  00 32 09  49  00 00 40 02  70 16  00 00 10 00 00 00  00  7C 01  F7
# F0  00 32 09  49  00 00 40 02  70 16  00 00 10 00 00 00  01  7A 01  F7
# F0  00 32 09  49  00 00 40 02  70 16  00 00 10 00 00 00  02  78 01  F7
# F0  00 32 09  49  00 00 40 02  70 16  00 00 10 00 00 00  03  76 01  F7
# F0  00 32 09  49  00 00 40 02  70 16  00 00 10 00 00 00  04  74 01  F7
# F0  00 32 09  49  00 00 40 02  70 16  00 00 10 00 00 00  05  72 01  F7
# F0  00 32 09  49  00 00 40 02  70 16  00 00 10 00 00 00  06  70 01  F7

# F0  00 32 09  49  00 00 40 02  63 2D  00 00 10 00 00 00  00  00 00  F7
# F0  00 32 09  49  00 00 40 02  63 2D  00 00 10 00 00 00  01  7E 03  F7
# F0  00 32 09  49  00 00 40 02  63 2D  00 00 10 00 00 00  02  7C 03  F7
# F0  00 32 09  49  00 00 40 02  63 2D  00 00 10 00 00 00  03  7A 03  F7
# F0  00 32 09  49  00 00 40 02  63 2D  00 00 10 00 00 00  04  78 03  F7
# F0  00 32 09  49  00 00 40 02  63 2D  00 00 10 00 00 00  05  76 03  F7
# F0  00 32 09  49  00 00 40 02  63 2D  00 00 10 00 00 00  06  74 03  F7

# F0  00 32 09  49  00 00 40 02  56 44  00 00 10 00 00 00  00  02 02  F7
# F0  00 32 09  49  00 00 40 02  56 44  00 00 10 00 00 00  01  00 02  F7
# F0  00 32 09  49  00 00 40 02  56 44  00 00 10 00 00 00  02  7E 01  F7
# F0  00 32 09  49  00 00 40 02  56 44  00 00 10 00 00 00  03  7C 01  F7
# F0  00 32 09  49  00 00 40 02  56 44  00 00 10 00 00 00  04  7A 01  F7
# F0  00 32 09  49  00 00 40 02  56 44  00 00 10 00 00 00  05  78 01  F7
# F0  00 32 09  49  00 00 40 02  56 44  00 00 10 00 00 00  06  76 01  F7

# F0  00 32 09  49  00 00 40 02  49 5B  00 00 10 00 00 00  00  06 00  F7
# F0  00 32 09  49  00 00 40 02  49 5B  00 00 10 00 00 00  01  04 00  F7
# F0  00 32 09  49  00 00 40 02  49 5B  00 00 10 00 00 00  02  02 00  F7
# F0  00 32 09  49  00 00 40 02  49 5B  00 00 10 00 00 00  03  00 00  F7
# F0  00 32 09  49  00 00 40 02  49 5B  00 00 10 00 00 00  04  7E 03  F7
# F0  00 32 09  49  00 00 40 02  49 5B  00 00 10 00 00 00  05  7C 03  F7
# F0  00 32 09  49  00 00 40 02  49 5B  00 00 10 00 00 00  06  7A 03  F7


# dev.set_bank(0, 0)
# print(" G: 00 32 09  49  00 00 40 02  70 16  00 00 10 00 00 00  00  7C 01\n")
# dev.set_bank(1, 0)
# print(" G: 00 32 09  49  00 00 40 02  70 16  00 00 10 00 00 00  01  7A 01\n")
# dev.set_bank(2, 0)
# print(" G: 00 32 09  49  00 00 40 02  70 16  00 00 10 00 00 00  02  78 01\n")

# dev.set_bank(0, 1)
# print(" G: 00 32 09  49  00 00 40 02  63 2D  00 00 10 00 00 00  00  00 00\n")
# dev.set_bank(1, 1)
# print(" G: 00 32 09  49  00 00 40 02  63 2D  00 00 10 00 00 00  01  7E 03\n")

# dev.set_bank(1, 2)
# print(" G: 00 32 09  49  00 00 40 02  56 44  00 00 10 00 00 00  01  00 02\n")

# dev.set_bank(1, 3)
# print(" G: 00 32 09  49  00 00 40 02  49 5B  00 00 10 00 00 00  01  04 00\n")
...
# F0  00 32 0D  41 00 00 40 02  62 0F 00 00  10 7E 00 00  1D 00  F7
# F0  00 32 0D  41 00 00 40 02  53 17 00 00  10 7E 00 00  28 00  F7
# F0  00 32 0D  41 00 00 40 02  44 1F 00 00  10 7E 00 00  33 00  F7
# F0  00 32 0D  41 00 00 40 02  35 27 00 00  10 7E 00 00  3E 00  F7
# F0  00 32 0D  41 00 00 40 02  26 2F 00 00  10 7E 00 00  49 00  F7
# F0  00 32 0D  41 00 00 40 02  17 37 00 00  10 7E 00 00  54 00  F7
# F0  00 32 0D  41 00 00 40 02  08 3F 00 00  10 7E 00 00  5F 00  F7
# F0  00 32 0D  41 00 00 40 02  79 46 00 00  10 7E 00 00  6A 00  F7
# F0  00 32 0D  41 00 00 40 02  6A 4E 00 00  10 7E 00 00  75 00  F7
# F0  00 32 0D  41 00 00 40 02  5B 56 00 00  10 4E 00 00  01 00  F7

# Set color, Presets 1, Bank 1 (0x1F - 0x05 = 26)
# 05 00 -> 5
# 1F 00 -> 31 (5 + 26)
# 39 00
# 53 00
# 6D 00
# 07 01 -> 135: (0x01 << 7) + 0x07
# 21 01
# 3B 01
# 55 01
# 6F 01
...
# Set color, Presets 1, Bank 2
# 25 03 [00 32 09 59 00 00 40 02 25 03 00 00 30 00 00 00 7F 00 00 10 0D]
# 3F 03
# 59 03
# 73 03
# 0D 04
...
# 17 16
# 31 16
# 4B 16 -> 2891: (0x16 << 7) + 0x4B

# Set color, Presets 2, Bank 1 (0x78 - 0x4B = 45)
# 78 16 -> 2936: (0x16 << 7) + 0x78, 2936 - 2891 = 45
#       -> [00 32 09 59 00 00 40 02 78 16 00 00 30 00 00 00 7F 00 00 28 0F]
# 12 17
# 2C 17
# 46 17
# 60 17
...
# Set color, Presets 3, Bank 1 (0x6B - 0x3E = 45)
# 6B 2D
# 05 2E
# 1F 2E
# 39 2E
...
# device.sync()
# color = (0, 0, 0)
# device.set_rgb_led(0, *color, bank=0, preset=0)
# device.set_rgb_led(1, *color, bank=0, preset=0)
# device.set_rgb_led(2, *color, bank=0, preset=0)
# device.set_rgb_led(3, *color, bank=0, preset=0)
# device.set_rgb_led(0, *color, bank=1, preset=0)
# device.set_rgb_led(0, *color, bank=6, preset=0)
# device.set_rgb_led(0, *color, bank=0, preset=1)
# device.set_rgb_led(15, *color, bank=3, preset=1)
# device.set_rgb_led(10, *color, bank=2, preset=2)
# device.set_rgb_led(11, *color, bank=2, preset=3)
# device.set_rgb_led(4, *color, bank=5, preset=3)


# Change NOTE number of PADs (bank 0, preset 0)
# F0  00 32 09  49 00 00 40 02  02 00  00 00 10 00 00 00  01  6C 03  F7
# F0  00 32 09  49 00 00 40 02  02 00  00 00 10 00 00 00  02  6A 03  F7
# F0  00 32 09  49 00 00 40 02  02 00  00 00 10 00 00 00  03  68 03  F7

# F0  00 32 09  49 00 00 40 02  02 00  00 00 10 00 00 00  00  6E 03  F7
# F0  00 32 09  49 00 00 40 02  1C 00  00 00 10 00 00 00  00  3A 03  F7
# F0  00 32 09  49 00 00 40 02  36 00  00 00 10 00 00 00  00  06 03  F7
# F0  00 32 09  49 00 00 40 02  50 00  00 00 10 00 00 00  00  52 02  F7
# F0  00 32 09  49 00 00 40 02  6A 00  00 00 10 00 00 00  00  1E 02  F7
# F0  00 32 09  49 00 00 40 02  04 01  00 00 10 00 00 00  00  6A 01  F7
# F0  00 32 09  49 00 00 40 02  1E 01  00 00 10 00 00 00  00  36 01  F7
# F0  00 32 09  49 00 00 40 02  38 01  00 00 10 00 00 00  00  02 01  F7
# F0  00 32 09  49 00 00 40 02  52 01  00 00 10 00 00 00  00  4E 00  F7
# F0  00 32 09  49 00 00 40 02  6C 01  00 00 10 00 00 00  00  1A 00  F7
# F0  00 32 09  49 00 00 40 02  06 02  00 00 10 00 00 00  00  64 03  F7
# F0  00 32 09  49 00 00 40 02  20 02  00 00 10 00 00 00  00  30 03  F7
# F0  00 32 09  49 00 00 40 02  3A 02  00 00 10 00 00 00  00  7C 02  F7
# F0  00 32 09  49 00 00 40 02  54 02  00 00 10 00 00 00  00  48 02  F7
# F0  00 32 09  49 00 00 40 02  6E 02  00 00 10 00 00 00  00  14 02  F7
# F0  00 32 09  49 00 00 40 02  08 03  00 00 10 00 00 00  00  60 01  F7

# Preset 0, bank 1
# F0  00 32 09  49 00 00 40 02  22 03  00 00 10 00 00 00  00  2C 01  F7
# F0  00 32 09  49 00 00 40 02  3C 03  00 00 10 00 00 00  00  78 00  F7
# F0  00 32 09  49 00 00 40 02  56 03  00 00 10 00 00 00  00  44 00  F7
# F0  00 32 09  49 00 00 40 02  70 03  00 00 10 00 00 00  00  10 00  F7
# ...

# Preset 0, Bank 6 (PADs 0 and 15)
# F0  00 32 09  49 00 00 40 02  42 13  00 00 10 00 00 00  00  5C 00  F7
# ...
# F0  00 32 09  49 00 00 40 02  48 16  00 00 10 00 00 00  00  4C 02  F7

# Preset 1, Bank 0 (PADs 0, 1, 2) [0x75 - 0x48 = 45]
# F0  00 32 09  49 00 00 40 02  75 16  00 00 10 00 00 00  00  72 01  F7
# F0  00 32 09  49 00 00 40 02  0F 17  00 00 10 00 00 00  00  3E 01  F7
# F0  00 32 09  49 00 00 40 02  29 17  00 00 10 00 00 00  00  0A 01  F7
# ...
