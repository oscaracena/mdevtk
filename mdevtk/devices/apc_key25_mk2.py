...
class APCKey25MK2(DeviceController):
    ...
    def __init__(self):
        ...
        self.on_note(channel=0, note=0,  cb="on_clip_1")
        self.on_note(channel=0, note=1,  cb="on_clip_2")
        self.on_note(channel=0, note=2,  cb="on_clip_3")
        self.on_note(channel=0, note=3,  cb="on_clip_4")
        self.on_note(channel=0, note=4,  cb="on_clip_5")
        self.on_note(channel=0, note=5,  cb="on_clip_6")
        self.on_note(channel=0, note=6,  cb="on_clip_7")
        self.on_note(channel=0, note=7,  cb="on_clip_8")
        self.on_note(channel=0, note=8,  cb="on_clip_9")
        self.on_note(channel=0, note=9,  cb="on_clip_10")
        self.on_note(channel=0, note=10, cb="on_clip_11")
        self.on_note(channel=0, note=11, cb="on_clip_12")
        self.on_note(channel=0, note=12, cb="on_clip_13")
        self.on_note(channel=0, note=13, cb="on_clip_14")
        self.on_note(channel=0, note=14, cb="on_clip_15")
        self.on_note(channel=0, note=15, cb="on_clip_16")
        self.on_note(channel=0, note=16, cb="on_clip_17")
        self.on_note(channel=0, note=17, cb="on_clip_18")
        self.on_note(channel=0, note=18, cb="on_clip_19")
        self.on_note(channel=0, note=19, cb="on_clip_20")
        self.on_note(channel=0, note=20, cb="on_clip_21")
        self.on_note(channel=0, note=21, cb="on_clip_22")
        self.on_note(channel=0, note=22, cb="on_clip_23")
        self.on_note(channel=0, note=23, cb="on_clip_24")
        self.on_note(channel=0, note=24, cb="on_clip_25")
        self.on_note(channel=0, note=25, cb="on_clip_26")
        self.on_note(channel=0, note=26, cb="on_clip_27")
        self.on_note(channel=0, note=27, cb="on_clip_28")
        self.on_note(channel=0, note=28, cb="on_clip_29")
        self.on_note(channel=0, note=29, cb="on_clip_30")
        self.on_note(channel=0, note=30, cb="on_clip_31")
        self.on_note(channel=0, note=31, cb="on_clip_32")
        self.on_note(channel=0, note=32, cb="on_clip_33")
        self.on_note(channel=0, note=33, cb="on_clip_34")
        self.on_note(channel=0, note=34, cb="on_clip_35")
        self.on_note(channel=0, note=35, cb="on_clip_36")
        self.on_note(channel=0, note=36, cb="on_clip_37")
        self.on_note(channel=0, note=37, cb="on_clip_38")
        self.on_note(channel=0, note=38, cb="on_clip_39")
        self.on_note(channel=0, note=39, cb="on_clip_40")
